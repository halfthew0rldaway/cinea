export const StreambertLogo = ({ style }) => (
  <svg
    ...
    style={{ width: "100%", height: "100%", display: "block", color: "var(--red)", ...style }}
  >
    <rect width="44" height="44" rx="12" fill="currentColor" fillOpacity="0.15" />
    <path d="M30 14 C 23 12, 14 15, 14 22 C 14 29, 23 32, 30 30" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
    <path d="M22 17 L 29 22 L 22 27 Z" fill="currentColor" />
  </svg>
);
...
export const DocumentIcon = ({ size = 18 }) => (
...
export const AnimeIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ToolIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path>
  </svg>
);

export const WavesIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const UtilityIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const TimerIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="14" r="8"></circle>
    <polyline points="12 10 12 14 14.5 16.5"></polyline>
